...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "feeds.CloudFeedAdapter.fetch",
    "generation.CloudGenerationAdapter.draft",
    "worklist_store.CloudWorklistStoreAdapter.get",
    "worklist_store.CloudWorklistStoreAdapter.list_for_tenant",
    "worklist_store.CloudWorklistStoreAdapter.put",
)
